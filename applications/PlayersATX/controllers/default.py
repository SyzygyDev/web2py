...
def _get_reservable_spaces():
	return [
		{"label":"Table 1", "group":"Bar side round table bottom of stairs"},
		{"label":"Table 2", "group":"Entrance side Round table bottom of stairs"},
		{"label":"Table 3", "group":"Large Round table close to bar"},
		{"label":"Table 4", "group":"L shaped table right side of entrance"},
		{"label":"Table 5", "group":"10 top table right of Entrance"},
		{"label":"Table 6", "group":"Small round table front of bar"},
		{"label":"Table 7", "group":"4 top right of entrance"},
		{"label":"Table 8", "group":"4 top closest to men's restroom"},
		{"label":"Table 9", "group":"4 top right of entrance"},
		{"label":"Table 10", "group":"4 top right of entrance"},
		{"label":"Table 11", "group":"4 top left of entrance by bar"},
		{"label":"Table 12", "group":"4 top left of entrance"},
		{"label":"Table 13", "group":"4 top left of entrance by bar"},
		{"label":"Table 14", "group":"4 top left of entrance"},
		{"label":"Table 15", "group":"4 top between entrance and pool table"},
		{"label":"Table 16", "group":"4 top between entrance and pool table"},
		{"label":"Table 17", "group":"10 top left of entrance by bar"},
