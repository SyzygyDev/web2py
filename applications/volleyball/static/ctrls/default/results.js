hellerVolleyBall.controller('HVBresults',
	[       '$scope', '$sce', '$document', 'tournamentGenerator',
	function($scope,   $sce,   $document,   tournamentGenerator) {
        ...
        $scope.getBracketUrl = function () {
            var thisUrl = "/volleyball/default/bracketA?team_count=" + $scope.playersToGenerate;
